...
def run_v2_iron_condor():
    ...
    print("="*50)
    print("Step 1: On your local PC browser, log into Flattrade using your API Key link.")
    print("Step 2: After logging in, you will be redirected. Look at the URL in your browser.")
    print("Step 3: Copy the characters after 'code='")
